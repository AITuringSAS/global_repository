...
def define_parameters():
    ...
    my_params.add_argument('--train_file_pattern', metavar='path/to/tfrecord/folder', type=str, default=os.path.join(*[os.getcwd(), 'tmp', 'tfrecords']),
    ...
    my_params.add_argument('--backbone_ckpt', metavar='path/to/checkpoint (default: efficientdet-d1)', type=str, default=os.path.join(*[os.getcwd(), 'efficientdet-zoo-models', 'efficientdet-d1']),
